...
KAKAO_TPL_AMATEUR_REVIEW_REQUEST = "UI_zzzz" # 아마추어 라운딩 후기/리뷰 요청 알림 (알리고 등록 필요, 예: "UI_zzzz")
...
def dispatch_push_notification(receiver, title, body, link=None, template_type=None):
    ...
    if SMS_PROVIDER != "none" and template_type:
        ...
        elif template_type == "amateur_review_request":
            tpl_code = KAKAO_TPL_AMATEUR_REVIEW_REQUEST
